...
export default function ContactUsSec({ className }) {
  return <>
    <section className={`ContactUs section ${className}`}>
          ...
          <div className="col-lg-6">
            <div className="form-content">
              ...
              <form action="">
                ...
                <MainBtn value="إرسال الرسالة" className='mx-auto' showIcon={false} />
              </form>
            </div>
          </div>
